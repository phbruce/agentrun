...
// Standalone Fastify server that serves both Slack events and MCP endpoints.
...
// to Slack within 3 seconds (their retry timeout).
...
// ── Slack events + interactions endpoint ──
...
app.post("/events", async (request, reply) => {
    ...
    // Slack interactions (buttons, dropdowns)
    ...
    // Process in background, respond immediately to Slack
